package cc.niaoer.kidsdrawingapp
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        llPaintColors = findViewById<LinearLayout>(R.id.ll_paint_colors)

        mImageButtonCurrentPaint = llPaintColors?.get(1) as ImageButton
    ...
    private fun showBrushSizeChooserDialog() {
        ...
        smallButton = brushDialog.findViewById<ImageButton>(R.id.ib_small_brush)
        mediumButton = brushDialog.findViewById<ImageButton>(R.id.ib_medium_brush)
        largeButton = brushDialog.findViewById<ImageButton>(R.id.ib_large_brush)
    ...
    private inner class BitmapAsyncTask(val mBitmap: Bitmap): AsyncTask<Any, Void, String>() {
        ...
        override fun onPostExecute(result: String?) {
            ...
            MediaScannerConnection.scanFile(this@MainActivity, arrayOf(result), null) { _, uri -> val shareIntent = Intent()
